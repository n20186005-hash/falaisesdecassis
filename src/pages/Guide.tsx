...
- 傍晚前往 **光影採石場（Carrières des Lumières）**：舊采石場改造的光影藝術館，投影 + 音樂沉浸式體驗，視覺震撼
  👉 **[光影採石場門票 & 開放時間預訂](https://www.trip.com/t/cbem5BtJDU2)**

### Day 2：馬賽歷史經典之旅
- 馬賽舊港出發，登 **伊夫島**，參觀 **伊夫城堡**：《基督山伯爵》經典取景地，百年監獄歷史感拉滿
  👉 **[伊夫島行程預訂](https://www.trip.com/t/Vere9GuJDU2)**
  👉 **[伊夫城堡門票詳情](https://www.trip.com/t/QikyawuJDU2)**

### 親子家庭專屬加選
- 帶娃優先安排 **巴本動物公園**：普羅旺斯心臟地帶的野生動物園，120 + 種動物、鳥類飛行表演、餵食互動，距離 Cassis 車程短
  👉 **[巴本動物公園門票資訊](https://www.trip.com/t/ENNHxEsJDU2)**

## 實用旅行 Tips

- **天氣與安全**：懸崖陣風強烈，勿靠近邊緣拍照；6-9 月嚴禁攜帶明火，關注火險預警。
- **飲食推薦**：Cassis 港口餐廳集中，必嘗當地海鮮、普羅旺斯燉菜與當地葡萄酒。
- **住宿推薦**：想節省時間可住 Cassis 小鎮，偏好便利選馬賽老港周邊
  👉 **[羅訥河口省高評分住宿預訂](https://www.trip.com/t/xVAmgGHKDU2)**
...
- In the evening, head to **Carrières des Lumières**: an immersive art gallery transformed from an old quarry, offering a visually stunning experience with projections and music.
  👉 **[Carrières des Lumières Tickets & Hours](https://www.trip.com/t/cbem5BtJDU2)**

### Day 2: Marseille Historical Classic Tour
- Depart from Marseille's Old Port, land on **Île d'If**, and visit **Château d'If**: the classic filming location for *The Count of Monte Cristo*, filled with the historical atmosphere of a century-old prison.
  👉 **[Île d'If Tour Booking](https://www.trip.com/t/Vere9GuJDU2)**
  👉 **[Château d'If Ticket Details](https://www.trip.com/t/QikyawuJDU2)**

### Family Exclusive Addition
- If traveling with kids, prioritize **Zoo de la Barben**: a wildlife park in the heart of Provence with over 120 animal species, bird flight shows, and feeding interactions, just a short drive from Cassis.
  👉 **[Zoo de la Barben Ticket Information](https://www.trip.com/t/ENNHxEsJDU2)**

## Practical Tips

- **Accommodation**: Stay in Cassis for convenience or around Marseille's Old Port for a city vibe.
  👉 **[Top-Rated Accommodation in Bouches-du-Rhône](https://www.trip.com/t/xVAmgGHKDU2)**
    ...
    <main className="min-h-screen bg-background text-foreground grain">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        <div className="rounded-2xl border border-border/70 bg-background/20 p-6 md:p-10 shadow-sm">
          <article className={`prose ${theme === 'dark' ? 'prose-invert' : ''} max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-p:leading-relaxed prose-a:text-[oklch(var(--accent))] prose-a:underline-offset-4 prose-strong:text-foreground`}>
            <Streamdown>
              {currentMarkdown}
            </Streamdown>
          </article>
