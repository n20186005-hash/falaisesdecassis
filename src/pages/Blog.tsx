...
const posts = [
  {
    ...
    description: "Falaises de Cassis 懸崖完整攻略，包含徒步路線、交通方式、最佳玩法、一日遊與二日遊建議，以及伊夫城堡、光影採石場、巴本動物公園等周邊推薦。",
    date: "2026-04-08",
    category: "Guide",
    path: "/guide"
  }
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <SEO 
        ...
        path="/blog" 
        customMeta={{
          title: `Blog & Articles - ${t.title}`,
          description: "Explore our latest guides, tips, and articles about Falaises de Cassis and the Calanques National Park."
        }}
      />
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 md:py-24">
          ...
          >
            ...
            <p className="font-editorial mt-5 text-base leading-relaxed text-muted-foreground md:text-lg">
              Discover everything you need to know about exploring the stunning Falaises de Cassis. From hiking routes to the best nearby attractions.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          {posts.length === 0 && (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">Check back later for new updates and guides.</p>
            </div>
          )}
        </div>
      </section>
